## Este diretório contém projetos desenvolvidos como parte da avaliação do módulo **"Sistemas Relacionais com Banco de Dados"**. Abaixo estão os projetos realizados, com suas respectivas descrições e objetivos:
